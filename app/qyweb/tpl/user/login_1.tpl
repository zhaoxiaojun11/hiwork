...
<head>
<meta charset="utf-8">
<title><?=qy::APP_NAME_ZH;?>-用户登陆-邮件验证码</title>
...
<section id="box">
	<h4 class="text-center"><?=qy::APP_NAME_ZH2;?>-用户登陆(邮箱+验证码)</h4>
	<div id="oth">使用 <a href="/user.html">用户名+密码</a> 登陆</div>
	<ul id="myform">
		<li  class="form-group">
			<input placeholder="邮箱帐号" class="form-control" id="username" type="text">
		</li>
		<li  class="form-group yzmbox">
			<input placeholder="请输入接收的验证码" class="form-control" id="yzm" type="number">
