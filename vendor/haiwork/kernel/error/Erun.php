...
class Erun extends \ErrorException
{
	...
	public static $localName = [
		...
		// 4016 => '开发者不认真导致的错误',
		0 => '开发者不认真导致的错误',//20200326092402
		-1 => '由开发者定义的错误',//20200326092402
	];
	...
	*/
	...
	{
		// 调试入口
		// var_dump(__METHOD__.'调试错误输出：', get_defined_vars());exit;
		if( \ERR_ON>1 ) return;//2级则忽略轻微错误
	...
	public static function dealErr1()
	{
		...
		// var_dump(__METHOD__.'调试错误输出：', $error);exit;
	...
	*/
	...
	{
		return self::$localCode[$code] ?? self::$localCode[4016];
	}
	/*
	...
	*/
	...
	{
		return self::$localName[$code] ?? self::$localName[4016];
	}
